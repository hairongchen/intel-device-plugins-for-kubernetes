...
type TdxDevicePlugin struct {
	...
	Status TdxDevicePluginStatus `json:"status,omitempty"`
	Spec   TdxDevicePluginSpec   `json:"spec,omitempty"`
}
...
type TdxDevicePluginList struct {
	...
	Items           []TdxDevicePlugin `json:"items"`
}

func init() {
	SchemeBuilder.Register(&TdxDevicePlugin{}, &TdxDevicePluginList{})
}
